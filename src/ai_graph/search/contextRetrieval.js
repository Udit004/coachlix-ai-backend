  ...
  return getCachedProfile(userId, async () => {
    try {
      const user = await User.findOne({ firebaseUid: userId })
        .select('name email age gender height weight targetWeight fitnessGoal experience activityLevel dietaryPreference allergies location bio')
        .lean();
      ...
      if (user.activityLevel) profile += `Activity Level: ${user.activityLevel}\n`;
